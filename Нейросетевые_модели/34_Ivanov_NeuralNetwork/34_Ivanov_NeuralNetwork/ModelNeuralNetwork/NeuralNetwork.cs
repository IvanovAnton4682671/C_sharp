...
namespace _34_Ivanov_NeuralNetwork.ModelNeuralNetwork
{
    class NeuralNetwork
    {
        ...
        public double E_error_awr { get { return e_error_awr; } set { e_error_awr = value; } }
        ...
        private Form createChartForm()
        {
            ...
            chartArea.AxisX.Title = "Эпохи"; // Подпись оси X
            chartArea.AxisX.TitleFont = new Font("Arial", 12, FontStyle.Bold); // Шрифт подписи оси X
            chartArea.AxisY.Title = "Ошибка"; // Подпись оси Y
            chartArea.AxisY.TitleFont = new Font("Arial", 12, FontStyle.Bold); // Шрифт подписи оси Y
